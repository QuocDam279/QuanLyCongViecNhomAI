...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed top-0 left-0 h-screen w-64 bg-white text-slate-800 flex flex-col justify-between shadow-md border-r border-slate-200">
      {/* Logo */}
      ...
      <div className="px-3 py-4 text-sm text-slate-400 border-t border-slate-200">
        © 2025 QuestDo
      </div>
    </aside>
  );
